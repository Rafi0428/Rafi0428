<p align="center">
  <img src="./MD%20RAFI%20AHMED_20260726_003238_0000.png" alt="MD Rafi Ahmed Banner">
</p>
<div align="center">
...
#### 🚗 Smart Automated Garage Architecture `[Hardware / C++]`
* **Role:** Hardware Architect & Logic Programmer
* **Overview:** A fully autonomous, bidirectional smart gate system bridging low-level C++ programming with physical hardware. Engineered a dual-sensor logic matrix to process real-time spatial data and trigger mechanical actuation seamlessly without human intervention.
* **Key Contributions:**
  * Engineered the core detection loop utilizing HC-SR04 ultrasonic sensors for deterministic spatial tracking and presence validation.
  * Programmed custom, micro-delay servo motor functions to simulate realistic, heavy-gate kinematics and physical weight.
  * Designed and documented the complete circuit architecture, effectively bridging 5V logic with real-world mechanical output.
...
* **Link:** [View Portal Live](https://rafi0428.github.io/rafi.github.io/)
* **Overview:** A personalized, multi-step digital web experience engineered to celebrate relationships and deliver custom, dynamic letters. Built with a focus on seamless state transitions, elegant typography, and engaging micro-animations (such as confetti triggers) to create an emotionally resonant, polished user interface.
...
Always open to discussing full-stack web development, intelligent automation, core computer science concepts, or the next hackathon build.
